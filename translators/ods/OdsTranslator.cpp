...
static status_t ReadASCD(BPositionIO* source, CContainer* doc)
{
	...
	// da kASCDVersion apposta, non lo stesso valore. Questa ReadASCD non
	...
	// stessa classe di bug gia' descritta sopra ("ASCD version bump
	// broke CSV/ODS export") ma non applicata a QUESTO bump -- scoperto
	// da test-export-formats (ODS scritto vuoto, 0 byte).
