...
# passare da haikuporter/atomo123-0.2.1.recipe: quella recipe richiede
...
#   cp atomo123-0.2.1-1-x86_64.hpkg ~/config/packages/   # solo per l'utente corrente
# oppure, per tutto il sistema (richiede privilegi):
#   cp atomo123-0.2.1-1-x86_64.hpkg /boot/system/packages/
